"""위프코리아 공개 승인된 데이터만 메모리로 수집한다. 저장은 별도 D1 도구가 한다."""
import base64
import contextlib
import io
import json
...
def collect():
    ...
    with contextlib.redirect_stdout(io.StringIO()):
        ...
        clients, names = builder.fetch_clients(nt, "whiffkorea")
        if len(clients) != 1:
    ...
    return {"slug": "whiffkorea", "buildKey": str(uuid.uuid4()), "startedAt": started,
